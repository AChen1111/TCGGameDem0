...
public static class ALogStackParser
{
    ...
    /// <summary>ALog 运行时与编辑器代码所在目录,这些帧不是日志的真实发出位置</summary>
    private static readonly string[] s_logSystemDirs =
    {
        "Assets/Scripts/LogSystem/",
        "Assets/Scripts/Editor/LogSystem/",
    };
    ...
    public static bool IsLogSystem(string filePath) {
        ...
        foreach (string dir in s_logSystemDirs)
        {
