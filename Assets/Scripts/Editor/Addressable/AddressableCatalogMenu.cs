...
{
    [MenuItem("Assets/Addressable/Add To Sprite Catalog", false, 2000)]
    ...
    [MenuItem("Assets/Addressable/Add To Sprite Catalog", true)]
    static bool ValidateAddToSpriteSO()
    {
        return SelectedPaths("t:Sprite").Count > 0;
    }

    [MenuItem("Assets/Addressable/Add To Prefab Catalog", false, 2001)]
    ...
    [MenuItem("Assets/Addressable/Add To Prefab Catalog", true)]
    static bool ValidateAddToPrefabSO()
    {
        return SelectedPaths("t:Prefab").Count > 0;
    }

    [MenuItem("Assets/Addressable/Add To Scene Catalog", false, 2002)]
    ...
    [MenuItem("Assets/Addressable/Add To Scene Catalog", true)]
    static bool ValidateAddToSceneSO()
    {
        return SelectedPaths("t:Scene").Count > 0;
    }

    [MenuItem("Assets/Addressable/Add To UISettings Catalog", false, 2003)]
    ...
    [MenuItem("Assets/Addressable/Add To UISettings Catalog", true)]
