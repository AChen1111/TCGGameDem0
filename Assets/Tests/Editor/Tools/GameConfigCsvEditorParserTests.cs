...
{
    const string Header = "Table,Id,Name,ResourceKey,PriceGold,StartsAt,EndsAt,SortOrder,IsEnabled,PoolKey\r\n";
    ...
    public void Parser_maps_all_three_tables_and_sorts_rows()
    {
        EditorGameConfigDocument document = GameConfigCsvEditorParser.Parse(Header +
            ...
            "CardPack,2,卡包,c_02,100,2026-09-01T00:00:00Z,2026-10-01T00:00:00Z,0,True,Card01\r\n");
        ...
        Assert.AreEqual("Card01", document.cardPacks[0].poolKey);
    }
    ...
    public void Parser_reports_source_line_for_table_specific_date_error()
    {
        var exception = Assert.Throws<System.FormatException>(() =>
            GameConfigCsvEditorParser.Parse(Header +
                "Avatar,0,默认头像,a_00,200,2026-10-01T00:00:00Z,2026-09-01T00:00:00Z,0,True,\r\n"));
